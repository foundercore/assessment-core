...
public class ConfigUtility {
    ...
    public String getProperty(String key, boolean suppressException) {
        if (!props.containsKey(key)) {
            if (!suppressException) {throw new ConfigurationException("Key : " + " not found");}
        }
    ...
    public String getTmpDir() {
        String s = getProperty("assessment.dir.tmp");
        if (s == null) {
            return "/tmp";
        }
        return s;
    ...
    // todo failed multi-nested-var config parsing
